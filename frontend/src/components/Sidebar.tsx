...
const Sidebar = ({ collapsed }: Prop) => {

  return (
    <aside className={`${collapsed ? 'w-20' : 'w-64'} bg-slate-900 text-white flex flex-col transition-all duration-300 overflow-hidden whitespace-nowrap`}>
      <div className={`h-16 flex items-center ${collapsed ? 'justify-center' : 'px-6'} text-2xl font-bold border-b border-slate-700 transition-all`}>
